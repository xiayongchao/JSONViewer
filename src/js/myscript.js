...
var jsonMenuRight = '<div class="btn-group-right"><a href="javascript:;" title="JSON示例">示例</a><button type="button" title="清空" data-value="clear"><i class="fa fa-eraser"></i></button><button type="button" title="复制" data-value="copy"><i class="fa fa-copy"></i></button><button type="button" title="粘贴" data-value="paste"><i class="fa fa-paste"></i></button><button type="button" title="下载" data-value="download"><i class="fa fa-download"></i></button><button type="button" title="关闭" data-value="close"><i class="fa fa-close"></i></button></div>';
var jsonMenuRightNoClose = '<div class="btn-group-right"><a href="javascript:;" title="JSON示例">示例</a><button type="button" title="清空" data-value="clear"><i class="fa fa-eraser"></i></button><button type="button" title="复制" data-value="copy"><i class="fa fa-copy"></i></button><button type="button" title="粘贴" data-value="paste"><i class="fa fa-paste"></i></button><button type="button" title="下载" data-value="download"><i class="fa fa-download"></i></button></div>';
